<template>
  <div>
    <head>
      ...
      <meta property="og:image" content="https://nufteg.com/images/og-image.jpg">
      ...
      <meta name="twitter:image" content="https://nufteg.com/images/twitter-card.jpg">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 col-md-12 text-center">
            <a href="#" class="header-top-link"><strong>بث تجريبي</strong></a>
          </div>
        </div>
      </div>
    </div>
