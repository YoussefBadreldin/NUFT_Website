<template>
 ...
 <div style="display: flex; flex-direction: column; align-items: center;">
    <img src="/images/Logos/Universites/National/NU.png" alt="University Logo" style="width: 100%; max-width: 300px; height: auto;">

    <!-- ######## Uni Title ####### -->
    <h2 style="text-align: center; margin-top: 20px;">(NU) جامعة النيل الاهلية </h2>

    <!-- ######## Uni info ####### -->
    <p style="text-align: center;">جامعة أهلية بدعم من وزارة الاتصالات وتكنولوجيا المعلومات المصرية
    <br>
أنشئت وفقًا للقرار الجمهوري رقم 255 لسنة 2006
</p>
...
<ul style="display: flex; justify-content: space-between; width: 100%; max-width: 300px;">
    <li><a href="https://www.nu.edu.eg"><i class="fas fa-globe"></i></a></li>
    <li><a href="tel:16453"><i class="fas fa-phone"></i></a></li>
    <li><a href="mailto:admission@nu.edu.eg"><i class="fas fa-envelope"></i></a></li>
    <li><a href="https://www.facebook.com/NileUniversity"><i class="fab fa-facebook-f"></i></a></li>
    <li><a href="https://www.instagram.com/nileuniversity.eg/"><i class="fab fa-instagram"></i></a></li>
    <li><a href="https://www.youtube.com/c/nileuniversity"><i class="fab fa-youtube"></i></a></li>
    <li><a href="https://www.linkedin.com/school/nile-university/"><i class="fab fa-linkedin-in"></i></a></li>
</ul>
    </div>
</div>
    </section>
    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.speciality === 'NU' && index.facality_or_international === 'facality');
                    this.filteredInternational = this.all_data.filter(index => index.facality_or_international === 'international' && index.speciality === 'NU');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university_Name === 'NU');
        ...
        async getDorms() {
            try {
                ...
                this.filteredDorms = this.dorms.filter(dorm => dorm.spec === 'NU');
        ...
        async gettrans() {
            try {
                ...
                this.filteredTrans = this.trans.filter(index => index.spec === 'NU');
