    ...
    <div>
        ...
        <section>
            <div style="display: flex; flex-direction: column; align-items: center;">
                <img src="/images/Logos/Universites/National/HNU.png" alt="University Logo" style="width: 100%; max-width: 300px; height: auto;">
                
                <!-- ######## Uni Title ####### -->
                <h2 style="text-align: center; margin-top: 20px;">جامعة  حلوان الاهلية<br>(HNU)</h2>
                
                <!-- ######## Uni info ####### -->
                <p style="text-align: center;">
                    جامعة أهلية منبثقة عن جامعة حلوان الحكومية 
                    <br>
                     أنشئت وفقًا للقرار الجمهوري رقم 43 لسنة 2022
                </p>
                
    <!-- ######## Uni Location ####### -->
    <p style="text-align: center;">تقع على مساحة 52 فدانا داخل حرم جامعة حلوان – عين حلوان في مدينة حلوان،محافظة القاهرة</p>
    <a href="https://goo.gl/maps/S6i7eTALNoFtNAX38?coh=178573&entry=tt" style="display: block; text-align: center;">
        <button>عرض الموقع على الخرائط</button>
                ...
                <div class="social-right-item" style="display: flex; justify-content: center; margin-top: 20px;">
                    <ul style="display: flex; justify-content: space-between; width: 100%; max-width: 300px;">
                        <li><a href="http://www.hnu.edu.eg/"><i class="fas fa-globe"></i></a></li>
                        <li><a href="tel:01100440119"><i class="fas fa-phone"></i></a></li>
                        <li><a href="mailto:studentaffairs@hnu.edu.eg"><i class="fas fa-envelope"></i></a></li>
                        <li><a href="https://www.facebook.com/HNU.Helwan/?paipv=0&eav=AfahNabYzoRKlqd3Vg3nJ6igWAuyRX3yIpDzVNLU5JaIQmtGK8pkVFUVLzt5zDiBgI8&_rdr"><i class="fab fa-facebook-f"></i></a></li>
    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.university === 'HNU' && index.normal_or_Dual === 'normal');
                    this.filteredInternational = this.all_data.filter(index => index.normal_or_Dual === 'dual' && index.university === 'HNU');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university === 'HNU');
