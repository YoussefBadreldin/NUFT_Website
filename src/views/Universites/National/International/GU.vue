<template>
    <div>
        ...
        <section>
            <div style="display: flex; flex-direction: column; align-items: center;">
                ...
                <!-- ######## Uni Title ####### -->
                <h2 style="text-align: center; margin-top: 20px;">جامعة الجلالة <br>(GU)</h2>
    ...
    <!-- ######## Uni Location ####### -->
    <p style="text-align: center;">تقع على مساحة 173 فدانا، بمدينة الجلالة، محافظة السويس وتضم مستشفى تعليمي بطاقة 577 سريرًا، وسكنًا خاصًا للطلاب وأعضاء هيئة التدريس </p>
