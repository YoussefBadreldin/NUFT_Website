    ...
    <div>
        ...
        <section>
            <div style="display: flex; flex-direction: column; align-items: center;">
                <img src="/images/Logos/Universites/Private/ACU.png" alt="University Logo" style="width: 100%; max-width: 300px; height: auto;">
                
                <!-- ######## Uni Title ####### -->
                <h2 style="text-align: center; margin-top: 20px;">جامعة  الاهرام الكندية<br>(ACU)</h2>
    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.speciality === 'ACU' && index.facality_or_international === 'facality');
                    this.filteredInternational = this.all_data.filter(index => index.facality_or_international === 'international' && index.speciality === 'ACU');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university_Name === 'ACU');
        ...
        async getDorms() {
            try {
                ...
                this.filteredDorms = this.dorms.filter(dorm => dorm.spec === 'ACU');
        ...
        async gettrans() {
            try {
                ...
                this.filteredTrans = this.trans.filter(index => index.spec === 'ACU');
