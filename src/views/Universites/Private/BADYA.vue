    ...
    <div>
        ...
        <section>
            <div style="display: flex; flex-direction: column; align-items: center;">
                <img src="/images/Logos/Universites/Private/BADYA.png" alt="University Logo" style="width: 100%; max-width: 300px; height: auto;">
                
                <!-- ######## Uni Title ####### -->
                <h2 style="text-align: center; margin-top: 20px;">جامعة  باديا<br>(BADYA)</h2>
    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.speciality === 'BADYA' && index.facality_or_international === 'facality');
                    this.filteredInternational = this.all_data.filter(index => index.facality_or_international === 'international' && index.speciality === 'BADYA');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university_Name === 'BADYA');
        ...
        async getDorms() {
            try {
                ...
                this.filteredDorms = this.dorms.filter(dorm => dorm.spec === 'BADYA');
        ...
        async gettrans() {
            try {
                ...
                this.filteredTrans = this.trans.filter(index => index.spec === 'BADYA');
