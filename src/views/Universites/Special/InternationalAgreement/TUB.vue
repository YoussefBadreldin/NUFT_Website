    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.university === 'TUB' && index.normal_or_Dual === 'normal');
                    this.filteredInternational = this.all_data.filter(index => index.normal_or_Dual === 'dual' && index.university === 'TUB');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university === 'TUB');
        ...
        async getDorms() {
            try {
                ...
                this.filteredDorms = this.dorms.filter(dorm => dorm.spec === 'TUB');
        ...
        async gettrans() {
            try {
                ...
                this.filteredTrans = this.trans.filter(index => index.spec === 'TUB');
