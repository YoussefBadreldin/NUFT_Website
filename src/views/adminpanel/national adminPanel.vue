<template>
    <div class="parent">
        ...
        <br><br>
        <h1>Add Universities Faculties</h1>        
        <div class="container">
...
<br><br>
        ...
        <h1>Add Universites Info & Links</h1>
...
<br><br>
        ...
        <h1>Add Universites Transportation</h1>
...
<br><br>
        ...
        <h1>Add Universites Admission Status</h1>
