...
export default {
    ...
    methods: {
        handleSubmit() {
            ...
            axios.post('https://nuft-website-backend-874bbf91403c.herokuapp.com/specialfaculty/addspecial', formData)
                .then(response => {
        ...
        links() {
            ...
            axios.post('https://nuft-website-backend-874bbf91403c.herokuapp.com/speciallinks/add_speciallinks', links_form_data)
                .then(() => {
                    alert('Form sent successfully');
                })
                .catch(error => {
        ...
        dorms() {
            ...
            axios.post('https://nuft-website-backend-874bbf91403c.herokuapp.com/info/addspecialdorms', form)
                .then(() => {
                    alert('Form sent successfully');
                })
                .catch(error => {
        ...
        trans() {
            ...
            axios.post('https://nuft-website-backend-874bbf91403c.herokuapp.com/specialtrans/addspecialtrans', form)
                .then(() => {
                    alert('Form sent successfully');
                })
                .catch(error => {
        ...
        admission() {
            ...
            axios.post('https://nuft-website-backend-874bbf91403c.herokuapp.com/specialadmission/add', form)
                .then(() => {
                    alert('Form sent successfully');
                })
                .catch(error => {
