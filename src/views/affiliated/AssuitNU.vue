        ...
        <section>
            <div style="display: flex; flex-direction: column; align-items: center;">
                ...
                <p style="text-align: center;">
                    جامعة أهلية منبثقة عن جامعة أسيوط الحكومية 
                    <br>
                     أنشئت وفقًا للقرار الجمهوري رقم 426 لسنة 2022
                </p>
                
    <!-- ######## Uni Location ####### -->
    <p style="text-align: center;">تقع على مساحة 38 فدانا، بمدينة أسيوط الجديدة، محافظة اسيوط وتضم معامل وورش، المنطقة الترفيهية</p>
    <a href="https://goo.gl/maps/JhzKUwqBohanowTd8?coh=178573&entry=tt" style="display: block; text-align: center;">
        <button>عرض الموقع على الخرائط</button>
                ...
                <div class="social-right-item" style="display: flex; justify-content: center; margin-top: 20px;">
                    <ul style="display: flex; justify-content: space-between; width: 100%; max-width: 300px;">
                        <li><a href="http://www.asnu.edu.eg/"><i class="fas fa-globe"></i></a></li>
                        <li><a href="tel:01118098888"><i class="fas fa-phone"></i></a></li>
                        <li><a href="mailto:info@asnu.edu.eg"><i class="fas fa-envelope"></i></a></li>
                        <li><a href="https://www.facebook.com/AssuitANU/"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href=""><i class="fab fa-instagram"></i></a></li>
                        <li><a href="https://www.youtube.com/channel/UCvNyCzOyVJo-bR75jyuIlWg/videos?view=0&sort=da"><i class="fab fa-youtube"></i></a></li>
    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.speciality === 'AssuitANU' && index.facality_or_international === 'facality');
                    this.filteredInternational = this.all_data.filter(index => index.facality_or_international === 'international' && index.speciality === 'AssuitANU');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university_Name === 'AssuitANU');
        ...
        async getDorms() {
            try {
                ...
                this.filteredDorms = this.dorms.filter(dorm => dorm.spec === 'AssuitANU');
        ...
        async gettrans() {
            try {
                ...
                this.filteredTrans = this.trans.filter(index => index.spec === 'AssuitANU');
