    ...
    <div>
        ...
        <section>
            <div style="display: flex; flex-direction: column; align-items: center;">
                <img src="/images/Logos/Universites/National/BNU.png" alt="University Logo" style="width: 100%; max-width: 300px; height: auto;">
                
                <!-- ######## Uni Title ####### -->
                <h2 style="text-align: center; margin-top: 20px;">جامعة  بنها الاهلية<br>(BNU)</h2>
                
                <!-- ######## Uni info ####### -->
                <p style="text-align: center;">
                    جامعة أهلية منبثقة عن جامعة بنها الحكومية 
                    <br> 
                    أنشئت وفقًا للقرار الجمهوري رقم 369 لسنة 2022
                </p>
                
    <!-- ######## Uni Location ####### -->
    <p style="text-align: center;">تقع على مساحة 40 فدانا، بمدينة العبور، محافظة القليوبية وتضم مسرح روماني ومنطقة رياضية ومنطقة ترفيهية</p>
    <a href="https://goo.gl/maps/yhHjbC6NqW6B85ZDA?coh=178573&entry=tt" style="display: block; text-align: center;">
        <button>عرض الموقع على الخرائط</button>
                ...
                <div class="social-right-item" style="display: flex; justify-content: center; margin-top: 20px;">
                    <ul style="display: flex; justify-content: space-between; width: 100%; max-width: 300px;">
                        <li><a href="https://bnu.edu.eg"><i class="fas fa-globe"></i></a></li>
                        <li><a href="tel:01205223222"><i class="fas fa-phone"></i></a></li>
                        <li><a href="mailto:info@ksiu.edu.eg"><i class="fas fa-envelope"></i></a></li>
                        <li><a href="https://www.facebook.com/BenhaNationalUniversity"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="https://www.instagram.com/BenhaNationalUniversity/"><i class="fab fa-instagram"></i></a></li>
                        <li><a href="https://www.youtube.com/channel/UC_8YOKgaBziBwIczl85xWHQ"><i class="fab fa-youtube"></i></a></li>
                        <li><a href="https://www.linkedin.com/school/benhanationaluniversity/"><i class="fab fa-linkedin-in"></i></a></li>
                    </ul>
                </div>
            </div>
        </section>
    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.speciality === 'BNU' && index.facality_or_international === 'facality');
                    this.filteredInternational = this.all_data.filter(index => index.facality_or_international === 'international' && index.speciality === 'BNU');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university_Name === 'BNU');
        ...
        async getDorms() {
            try {
                ...
                this.filteredDorms = this.dorms.filter(dorm => dorm.spec === 'BNU');
        ...
        async gettrans() {
            try {
                ...
                this.filteredTrans = this.trans.filter(index => index.spec === 'BNU');
