    ...
    <div>
        ...
        <section>
            <div style="display: flex; flex-direction: column; align-items: center;">
                <img src="/images/Logos/Universites/National/MenofiaNU.png" alt="University Logo" style="width: 100%; max-width: 300px; height: auto;">
                
                <!-- ######## Uni Title ####### -->
                <h2 style="text-align: center; margin-top: 20px;">جامعة  المنوفية الاهلية<br>(MNU)</h2>
                
                <!-- ######## Uni info ####### -->
                <p style="text-align: center;">
                    جامعة أهلية منبثقة عن جامعة المنوفية الحكومية 
                    <br> 
                   أنشئت وفقًا للقرار الجمهوري رقم 423 لسنة 2022
                </p>
                
    <!-- ######## Uni Location ####### -->
    <p style="text-align: center;">تقع على مساحة 18 فدانا،بمركز بركة السبع، محافظة المنوفية وتضم قاعات للاحتفالات والمؤتمرات، مسرح، منطقة ترفيهية وكافتيريا</p>
    <a href="https://goo.gl/maps/3JDNgVrL5sFecZqp9?coh=178573&entry=tt" style="display: block; text-align: center;">
        <button>عرض الموقع على الخرائط</button>
                ...
                <div class="social-right-item" style="display: flex; justify-content: center; margin-top: 20px;">
                    <ul style="display: flex; justify-content: space-between; width: 100%; max-width: 300px;">
                        <li><a href="https://mnu.menofia.education/"><i class="fas fa-globe"></i></a></li>
                        <li><a href="tel:"><i class="fas fa-phone"></i></a></li>
                        <li><a href="mailto:support@mnu.edu.eg "><i class="fas fa-envelope"></i></a></li>
                        <li><a href="https://www.facebook.com/MenoufiaNU.Official"><i class="fab fa-facebook-f"></i></a></li>
    ...
    methods: {
        async get_data() {
            try {
                ...
                if (Array.isArray(this.all_data)) {
                    ...
                    this.filteredData = this.all_data.filter(index => index.speciality === 'MenofiaNU' && index.facality_or_international === 'facality');
                    this.filteredInternational = this.all_data.filter(index => index.facality_or_international === 'international' && index.speciality === 'MenofiaNU');
        ...
        async getLinks() {
            try {
                ...
                this.filteredLinks = this.links.filter(index => index.university_Name === 'MenofiaNU');
        ...
        async getDorms() {
            try {
                ...
                this.filteredDorms = this.dorms.filter(dorm => dorm.spec === 'MenofiaNU');
        ...
        async gettrans() {
            try {
                ...
                this.filteredTrans = this.trans.filter(index => index.spec === 'MenofiaNU');
